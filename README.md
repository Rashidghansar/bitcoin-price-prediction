...
Before running, make sure the path to the Keras model in app.py is correct.
...
Historical data fetched live from Yahoo Finance.
...
📌 Note
Ensure the trained model (Bitcoin_Price_prediction_Model.keras) path is correctly set in app.py:
...
✨ Credits
Project developed by [Your Name] as part of a machine learning exploration using time series data.
